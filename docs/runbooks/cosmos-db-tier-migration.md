...
| ------------ | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Date**     | 2026-07-09                                                                                                                                                                                                                                                                                                                                                                                           |
| **Status**   | **Migration complete.** Cutover 2026-07-10 00:08 UTC; old account `cosmos-sudoku-prod` deleted 2026-07-27 (Phase 6). Production runs on `cosmos-sudoku-prod2` (serverless), off the free tier. Phases 0-6 done; Phase 7 code cleanup shipped (#357). No rollback path remains. Optional tail, none blocking: verify/delete the stale App Config keys in `appcs-xenobiasoft-prod` (the ✅ on that Phase 7 bullet contradicts its own text — confirm in Azure rather than trusting either), switch Cosmos auth from account key to managed identity, and drop the now-unused `cosmosDbEnableFreeTier` Bicep param.                                                              |

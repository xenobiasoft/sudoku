...
/// </summary>
public class ApiBasedAliasService(
    IPlayerApiClient playerApiClient,
    ILocalStorageService localStorageService,
    ILogger<ApiBasedAliasService> logger)
    : IAliasService
{
    ...
    private readonly ILogger<ApiBasedAliasService> _logger = logger ?? throw new ArgumentNullException(nameof(logger));

...
{
    public static GameModel GetPuzzle(GameDifficulty difficulty, bool rotateGrid = false)
    {
    ...
    public static GameModel GetEmptyPuzzle()
    {
        return PopulateCells(DefaultPuzzle);
    }

    public static GameModel GetInvalidPuzzle()
    {
        return PopulateCells(InvalidPuzzle);
    }

    public static GameModel GetSolvedPuzzle()
    {
    ...
    public static GameModel PopulateCells(int?[,] values)
    {

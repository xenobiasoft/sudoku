...
public interface IGameApplicationService
{
    ...
    Task<Result> MakeMoveAsync(string gameId, int row, int column, int? value, TimeSpan playDuration);
    ...
    Task<Result> UpdateGameStatusAsync(string gameId, string gameStatus);
